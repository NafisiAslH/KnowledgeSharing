...
async function DailyTagProcessing(url,end_day=31) {
    ...
    for (let i = day; i <= end_day; i++) {
        console.log("Processing day " + days_str[i] + " ....");
